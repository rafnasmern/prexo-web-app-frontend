...

                    {
                        ...
                        validate ?
                            <Button variant="contained"
                                ...
                                onClick={(e) => { handelSubmit(e) }} >Submit</Button>
                            :
                            <Button variant="contained"
                                fullWidth
                                sx={{ mt: 3, mb: 1 }}
                                ...
                                style={{ backgroundColor: "#206CE2" }}
                                onClick={(e) => { handelValidate(e) }} >Validate Data</Button>
                    }
                            ...
                            {item.map((data, index) => (
                                <TableRow >
                                    ...
                                    <TableCell >
                                        ...
                                        />
                                        {
                                            err?.order_id_is_duplicate?.includes(data["order_id"]) || Object.keys(err).length != 0 && data["order_id"] == undefined || Object.keys(err).length != 0 && data["order_id"] == ""
                                                ?
...

                                        {
                                            err?.order_id_is_duplicate?.includes(data["order_id"])
                                                ...
                                                :
                                                Object.keys(err).length != 0 && data["order_id"] == undefined || Object.keys(err).length != 0 && data["order_id"] == "" ?
                                    ...
                                    />
                                        {
                                            err?.partner_id_does_not_exist?.includes(data["partner_id"]) || Object.keys(err).length != 0 && data["partner_id"] == undefined || Object.keys(err).length != 0 && data["partner_id"] == ""
                                                ?
                                                <ClearIcon style={{ color: 'red' }} />
                                                :
                                                Object.keys(err).length != 0 ?
                                        ...
                                        }
                                        {
                                            err?.partner_id_does_not_exist?.includes(data["partner_id"])
                                                ...
                                                :
                                                Object.keys(err).length != 0 && data["partner_id"] == undefined || Object.keys(err).length != 0 && data["partner_id"] == "" ?
                                                    <p style={{ color: 'red' }} >Partner Id Does Not Exist</p>
                                                    :
                                                    ""
                                        }</TableCell>
                                    ...
                                    />
                                        {
                                            err?.location_does_not_exist?.includes(data["partner_shop"]) || Object.keys(err).length != 0 && data["partner_shop"] == undefined || Object.keys(err).length != 0 && data["partner_shop"] == ""
                                                ?
                                                <ClearIcon style={{ color: 'red' }} />
                                                :
                                                Object.keys(err).length != 0 ?
...

                                        {
                                            err?.location_does_not_exist?.includes(data["partner_shop"])
                                                ...
                                                :
                                                Object.keys(err).length != 0 && data["partner_shop"] == undefined ?
                                    ...
                                    <TableCell>
                                        ...
                                        />
                                        {
                                            err?.item_id_does_not_exist?.includes(data["item_id"]) || Object.keys(err).length != 0 && data["item_id"] == undefined || Object.keys(err).length != 0 && data["item_id"] == ""
                                                ?
                                                <ClearIcon style={{ color: 'red' }} />
                                                :
                                                Object.keys(err).length != 0 ?
                                        ...
                                        }
                                        {
                                            err?.item_id_does_not_exist?.includes(data["item_id"])
                                                ...
                                                :
                                                Object.keys(err).length != 0 && data["item_id"] == undefined || Object.keys(err).length != 0 && data["item_id"] == "" ?
                                                    <p style={{ color: 'red' }} >Item Id Does Not Exist</p>
                                                    :
                                                    ""
                                        }
                                    ...
                                    <TableCell>
                                        ...
                                        />
                                        {
                                            err?.brand_name_does_not_exist?.includes(data["old_item_details"].split(":")[0]) || Object.keys(err).length != 0 && data["old_item_details"].split(":")[0] == undefined || Object.keys(err).length != 0 && data["old_item_details"]?.split(":")[0] == ""
                                                ?
                                                <ClearIcon style={{ color: 'red' }} />
                                                :
                                                Object.keys(err).length != 0 ?
                                                    <DoneIcon style={{ color: 'green' }} />
                                                    :
                                                    err?.model_name_does_not_exist?.includes(data["old_item_details"].split(":")[1]) || Object.keys(err).length != 0 && data["old_item_details"].split(":")[1] == undefined || Object.keys(err).length != 0 && data["old_item_details"]?.split(":")[1] == ""
                                                        ?
                                                        <ClearIcon style={{ color: 'red' }} />
                                                        :
                                                        Object.keys(err).length != 0 ?
                                        ...
                                        {
                                            err?.brand_name_does_not_exist?.includes(data["old_item_details"].split(":")[0])
                                                ?
                                                <p style={{ color: 'red' }} >This Brand Name Does Not Exist</p>
                                                :

                                                err?.model_name_does_not_exist?.includes(data["old_item_details"].split(":")[1])
                                                    ?
                                                    <p style={{ color: 'red' }} >Model Name Does Not Exist</p>
                                                    :

                                                    Object.keys(err).length != 0 && data["old_item_details"].split(":")[0] == undefined || Object.keys(err).length != 0 && data["old_item_details"]?.split(":")[0] == "" ?
                                                        <p style={{ color: 'red' }} >This Brand Name Does Not Exist</p>
                                                        :
                                                        Object.keys(err).length != 0 && data["old_item_details"].split(":")[1] == undefined || Object.keys(err).length != 0 && data["old_item_details"]?.split(":")[1] == "" ?
                                                            <p style={{ color: 'red' }} >Model Name Does Not Exist</p>
                                                            :
                                                            ""
                                    ...
                                    />
                                        {
                                            err?.imei_number_is_duplicate?.includes(data["imei"]) || Object.keys(err).length != 0 && data["imei"] == undefined || Object.keys(err).length != 0 && data["imei"] == ""
                                                ?
                                                <ClearIcon style={{ color: 'red' }} />
                                                :
                                                Object.keys(err).length != 0 ?
                                        ...
                                        }
                                        {
                                            err?.imei_number_is_duplicate?.includes(data["imei"])
                                                ...
                                                :
                                                Object.keys(err).length != 0 && data["imei"] == undefined || Object.keys(err).length != 0 && data["imei"] == "" ?
                                                    <p style={{ color: 'red' }} >IMEI Number Does Not Exist </p>
                                                    :
                                                    ""
                                        }</TableCell>
                                    <TableCell> <TextField
                                    ...
                                    <TableCell>
                                        <TextField
                                            ...
                                            value={data["customer_declaration_physical_defect_present"]}
                                            inputProps={{
                                                style: {
                                                    width: "auto"
                                                }
                                    ...
                                    <TableCell>
                                        {
                                            Object.keys(err).length != 0 && data["partner_id"] == "" ||
                                                Object.keys(err).length != 0 && data["order_id"] == "" ||
                                                Object.keys(err).length != 0 && data["partner_shop"] == "" ||
                                                Object.keys(err).length != 0 && data["item_id"] == "" ||
                                                Object.keys(err).length != 0 && data["old_item_details"]?.split(":")[0] == "" ||
                                                Object.keys(err).length != 0 && data["old_item_details"]?.split(":")[1] == "" ||
                                                Object.keys(err).length != 0 && data["imei"] == "" ||
                                                err?.order_date?.includes(data["order_date"]) ||
                                                err?.order_timestamp?.includes(data["order_timestamp"]) ||
                                                err?.delivery_date?.includes(data["delivery_date"]) ||
                                                err?.order_id_is_duplicate?.includes(data["order_id"]) == true ||
                                                Object.keys(err).length != 0 && data["order_id"] == undefined ||
                                                err?.partner_id_does_not_exist?.includes(data["partner_id"]) == true ||
                                                Object.keys(err).length != 0 && data["partner_id"] == undefined || err?.location_does_not_exist?.includes(data["partner_shop"]) == true ||
                                                Object.keys(err).length != 0 && data["partner_shop"] == undefined
                                                || err?.item_id_does_not_exist?.includes(data["item_id"]) == true ||
                                                Object.keys(err).length != 0 && data["item_id"] == undefined ||
                                                err?.brand_name_does_not_exist?.includes(data["old_item_details"].split(":")[0]) == true ||
                                                Object.keys(err).length != 0 && data["old_item_details"].split(":")[0] == undefined
                                                || err?.model_name_does_not_exist?.includes(data["old_item_details"].split(":")[1]) == true ||
                                                data["old_item_details"].split(":")[1] == undefined ||
                                                err?.imei_number_is_duplicate?.includes(data["imei"]) == true || Object.keys(err).length != 0 && data["imei"] == undefined ?
                                                ...
                                                <Button
                                                    ...
                                                    component="span"
                                                    onClick={() => { if (window.confirm('You Want to Remove?')) { handelDelete(index) } }}
