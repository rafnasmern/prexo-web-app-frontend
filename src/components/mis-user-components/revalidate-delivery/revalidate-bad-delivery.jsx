                        ...
                        /> */}
                        {
                                ...
                                validate ?
                                    <Button variant="contained"
                                        ...
                                        onClick={(e) => { handelSubmit() }} >Submit</Button>
                                    :
                                    <Button variant="contained"
                                        fullWidth
                                        sx={{ mt: 3, mb: 1 }}
                                        ...
                                        style={{ backgroundColor: "#206CE2" }}
                                        onClick={(e) => { handelValidation(e) }} >Validate Data</Button>
                                ...
                                {item.map((data, index) => (
                                    <TableRow tabIndex={-1}>
                                        ...
                                        <TableCell>
                                            ...
                                            />
                                            {
                                                err?.duplicate_tracking_id?.includes(data.tracking_id?.toString()) || Object.keys(err).length != 0 && data.tracking_id == undefined || Object.keys(err).length != 0 && data.tracking_id == ""
                                                    ?
                                            ...
                                            {
                                                err?.duplicate_tracking_id?.includes(data.tracking_id?.toString())
                                                    ?
                                                    <p style={{ color: 'red' }} >Duplicate Tracking ID</p>
                                                    :

                                                    Object.keys(err).length != 0 && data.tracking_id == undefined || Object.keys(err).length != 0 && data.tracking_id == "" ?
                                        ...
                                        <TableCell>
                                            ...
                                            />
                                            {
                                                err?.duplicate_order_id_found?.includes(data.order_id?.toString()) || Object.keys(err).length != 0 && data.order_id == undefined || Object.keys(err).length != 0 && data.order_id == ""
                                                    ?
                                                    <ClearIcon style={{ color: 'red' }} />
                                                    :
                                                    Object.keys(err).length != 0 ?
                                            ...
                                            {
                                                err?.duplicate_order_id_found?.includes(data.order_id?.toString())
                                                    ?
                                        ...
                                        <TableCell>
                                            ...
                                            />
                                            {
                                                err?.delivery_date?.includes(data.order_date?.toString())
                                                    ?
                                                    <ClearIcon style={{ color: 'red' }} />
                                                    :
                                                    Object.keys(err).length != 0 ?
                                        ...
                                        <TableCell>
                                            ...
                                            />
                                            {
                                                err?.item_does_not_exist?.includes(data.item_id?.toString()) || Object.keys(err).length != 0 && data?.item_id == undefined || Object.keys(err).length != 0 && data?.item_id == ""
                                                    ?
                                                    <ClearIcon style={{ color: 'red' }} />
                                                    :
                                                    Object.keys(err).length != 0 ?
                                            ...
                                            {
                                                err?.item_does_not_exist?.includes(data.item_id?.toString())
                                                    ?
                                        ...
                                        <TableCell>
                                            ...
                                            />
                                            {
                                                err?.location_does_not_exist?.includes(data.partner_shop?.toString()) || Object.keys(err).length != 0 && data?.partner_shop == undefined || Object.keys(err).length != 0 && data?.partner_shop == ""
                                                    ?
                                                    <ClearIcon style={{ color: 'red' }} />
                                                    :
                                                    Object.keys(err).length != 0 ?
                                            ...
                                            {
                                                err?.location_does_not_exist?.includes(data.partner_shop?.toString())
                                                    ?
                                                    <p style={{ color: 'red' }} >You Can't Add This Data</p>
                                                    :
                                                    Object.keys(err).length != 0 && data?.partner_shop == undefined || Object.keys(err).length != 0 && data?.partner_shop == "" ?
                                        ...
                                        <TableCell>
                                            {
                                                err?.delivery_date?.includes(data.order_date?.toString()) ||
                                                    ...
                                                    Object.keys(err).length != 0 && data.order_date == undefined ||
                                                    Object.keys(err).length != 0 && data.order_date == "" ||
                                                    err?.duplicate_tracking_id?.includes(data.tracking_id?.toString()) == true ||
                                                    Object.keys(err).length != 0 && data?.tracking_id == undefined ||
                                                    err?.duplicate_order_id_found?.includes(data.order_id?.toString()) == true ||
                                                    Object.keys(err).length != 0 && data?.order_id == undefined ||
                                                    err?.item_does_not_exist?.includes(data.item_id?.toString()) == true ||
                                                    Object.keys(err).length != 0 && data.item_id == undefined
                                                    || err?.location_does_not_exist?.includes(data.partner_shop?.toString()) == true ||
